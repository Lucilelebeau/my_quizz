...
class __TwigTemplate_34b21a48b6f86277b66633f7e3c6abb3db5a3f16cf0e231840d116079e68a2fe extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"titre\">
    ...
    <h4>Le meilleur site pour passer le temps pendant le confinement !</h4><br><br><br>
</div>
  ...
  <div class=\"card-header text-center\">
    ...
    <ul class=\"list-group list-group-flush\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 22), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorie"], "name", [], "any", false, false, false, 22), "html", null, true);
            echo "</a></li>
        ";
        }
...
";
    ...
    {
        return array (  122 => 24,  109 => 22,  105 => 21,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
  ...
  <div class=\"card-header text-center\">
    ...
    <ul class=\"list-group list-group-flush\">
        {% for categorie in categories %}
            <li class=\"list-group-item\"><a href=\"/categorie/{{ categorie.id }}/start/0\"/>{{ categorie.id }} {{ categorie.name }}</a></li>
        {% endfor %}
    </ul>
</div>
{% endblock %}
